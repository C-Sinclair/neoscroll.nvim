...
let g:neoscroll_time_step_cursor_scroll = get(g:, 'neoscroll_time_step_cursor_scroll', 8)
let g:neoscroll_time_step_no_cursor_scroll = get(g:, 'neoscroll_time_step_no_cursor_scroll', 20)
